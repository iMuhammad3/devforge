  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        <Link to="/" onClick={closeMenu} className="text-sm font-bold tracking-tight">
          DevForge
        </Link>
      ...
      {isOpen && (
        <div className="border-t border-border bg-background px-6 py-4 md:hidden">
          <div className="flex flex-col gap-2">
            ...
            {user ? (
              <>
                <MobileNavItem to="/dashboard" onClick={closeMenu}>
                  Dashboard
                </MobileNavItem>

                <MobileNavItem to="/bookmarks" onClick={closeMenu}>
                  Bookmarks
                </MobileNavItem>
                ...
                <MobileNavItem to="/settings" onClick={closeMenu}>
                  Settings
                </MobileNavItem>
